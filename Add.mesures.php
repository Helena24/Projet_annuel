...
if(isset($_POST['enregistrer']))
{
	...
	$Requete = $connect->prepare('INSERT INTO `mesures`(`ID_CLIENT`,`DATE_MESURE`, `POURCENTAGE_MASSSE_GRAISSEUSE`, `POURCENTAGE_EAU_CORPS`, `GRAISSE_VISCERALE`, `MASSE_MUSCULAIRE`, `INDICE_EFFORT`, `MASSE_OSSEUSE`, `AGE_METABOLIQUE`) 
